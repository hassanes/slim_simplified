...
# ==============================================================================
r"""Downloads and converts images data to TFRecords of TF-Example protos.

This module downloads the images data, uncompresses it, reads the files
that make up the images data and creates two TFRecord datasets: one for train
...
def _get_filenames_and_classes(dataset_dir):
  ...
  """
  #image_root = os.path.join(dataset_dir, 'learn_photos')
...
def _clean_up_temporary_files(dataset_dir):
  ...
  tmp_dir = os.path.join(dataset_dir, 'learn_photos')
...
def run(dataset_dir, num_validation, num_shards):
